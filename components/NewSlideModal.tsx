...
const NewSlideModal: React.FC<NewSlideModalProps> = ({ isOpen, onClose, onConfirm, isGenerating, language }) => {
      ...
      <div className="bg-zinc-900 border border-zinc-700 rounded-xl shadow-2xl max-w-lg w-full p-6 space-y-4">
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            <Plus size={18} className="text-purple-400" /> {t.addSlideTitle}
          </h3>
        ...
        <div className="flex justify-end gap-3 pt-2">
          ...
          >
            ...
            {isGenerating ? t.creating : t.createSlide}
          </button>
        </div>
      </div>
    </div>
