  ...
  return (
    <div className="flex-1 bg-zinc-900/50 flex flex-col relative overflow-hidden">
                        ...
                        {slide.isGeneratingImage && (
                            <>
                                <div className="flex flex-col items-center gap-2 text-purple-400 animate-pulse">
                                    ...
                                    <span className="text-sm font-medium tracking-widest">{t.creatingVisuals}</span>
                                </div>
                                <button 
                                ...
                                >
                                    <Square size={16} fill="currentColor" /> {t.stopGenerating}
                                </button>
                            </>
                        )}
                         {slide.generationFailed && (
                            <div className="flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-300">
                                <div className="flex flex-col items-center gap-2 text-red-400">
                                    ...
                                    <span className="text-lg font-bold tracking-wide text-white">{t.generationFailed}</span>
        ...
        <div className="bg-zinc-950 py-2 text-center text-xs text-zinc-500 border-t border-zinc-800 flex justify-center gap-4">
            <span className="flex items-center gap-1"><MousePointer2 size={12}/> {t.editTextHint}</span>
            <span className="flex items-center gap-1">{t.formatHint}</span>
        </div>
    </div>
  );
};
